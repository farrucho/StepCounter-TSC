...
def main():
    ...
    mx_precision = 'int2' # MX element format. Test also other formats, e.g. 'int4', 'fp6_e2m3'
    ...
    # Backward pass
    # mx_specs['w_elem_format_bp'] = mx_precision     # MX format for backward pass weights
    # mx_specs['a_elem_format_bp_ex'] = mx_precision  # MX format for backward pass activations related to weight update
    # mx_specs['a_elem_format_bp_os'] = mx_precision  # MX format for backward pass activations related to error gradient

    # mx_specs['custom_cuda'] = True        # Use custom CUDA implementation of library
